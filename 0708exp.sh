...
# 变量
dl=/del/null
rcerb=/usr/share/metasploit-framework/modules/exploits/windows/rdp
rdprb=/usr/share/metasploit-framework/lib/msf/core/exploit/
rdp_scanner=/usr/share//metasploit-framework/modules/auxiliary/scanner/rdp/
cvebluekeep=/usr/share/metasploit-framework/modules/auxiliary/scanner/rdp/
src0708rce=/root/Desktop/cve_2019_0708_bluekeep_rce
...
cd /root/Desktop/&&git clone https://github.com/NAXG/cve_2019_0708_bluekeep_rce.git >>dl 2>&1
if [ $? -eq 0 ];then
